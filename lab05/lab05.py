...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    is_1_closer = (sqrt((lat - get_lat(city1))**2 + (lon - get_lon(city1))**2) <= sqrt((lat - get_lat(city2))**2 + (lon - get_lon(city2))**2))
    return get_name(city1) if is_1_closer else get_name(city2)
...
def acorn_finder(t):
    ...
    # if label(t) == 'acorn':
    #     return True
    return True if label(t) == 'acorn' else True in [acorn_finder(b) for b in branches(t)]
        # for b in branches(t):
        #     if label(b) == 'acorn':
        #         return True
        #     else:
        #         if not is_leaf(b) and acorn_finder(b):
        #             return True
        # return False
